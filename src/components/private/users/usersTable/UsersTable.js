...
import { getUsers, deleteUser, getSingleUser } from '../../../../actions/adminActions'
...
class UsersTable extends Component {
    ...
    _editHandler = (id) => {
        ...
        this.props.push('/admin/users/add')
    ...
    render() {
        ...
        if (this.props.users) {
            ...
            rows = this.props.users.users.map((user) => {
                ...
                return {
                    username: user.local ? user.local.username : user.facebook.username,
                    email: user.local ? user.local.email : user.facebook.email,
                    role: getRole(user),
